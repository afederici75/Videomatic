...
public class ArtifactProducerTests : IClassFixture<DbContextFixture>
{
    public ArtifactProducerTests(
    ...
    public IArtifactProducer ArtifactProducer { get; }
    ...
    [Fact]
    public async Task CreateEmbeddingsFromText()
    {
        await ArtifactProducer.CreateEmbeddings(
            "YOUTUBE",
            "n1kmKpjk_8E",
            AldousHuxley_DancingShiva2);
    }
}