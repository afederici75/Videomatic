...
public class SqlServerPlaylistsTests : IClassFixture<SqlServerDbContextFixture>
{
    ...
    public async Task T04_CreatePlaylistWithACompleteVideo()
    {
       ...
       vid1.AddThumbnail(new Thumbnail(vid1.Id, location: "youtubethumbs.com/T1_1", resolution: ThumbnailResolution.Default, height: 100, width: 100))
           .AddThumbnail(new Thumbnail(vid1.Id, location: "youtubethumbs.com/T1_2", resolution: ThumbnailResolution.Medium, height: 200, width: 200));
       
       vid1.AddTag("Tag1")
           .AddTag("Tag2");
       
       vid1.AddArtifact(new Artifact(vid1.Id, title: "A complete summary", type: "AI", text: "Bla bla"))
           .AddArtifact(new Artifact(vid1.Id, title: "A complete analysis", type: "AI", text: "More bla bla"));
       
       var trans1 = new Transcript(vid1.Id, "EN");
       trans1.AddLine(new TranscriptLine(trans1.Id, text: "This is", startsAt: TimeSpan.FromSeconds(0), duration: TimeSpan.FromSeconds(1)));
       trans1.AddLine(new TranscriptLine(trans1.Id, text: "a long transcript", startsAt: TimeSpan.FromSeconds(2), duration: TimeSpan.FromSeconds(2)));
       
       var trans2 = new Transcript(vid1.Id, "IT");
       trans1.AddLine(new TranscriptLine(trans2.Id, text: "Questa e'", startsAt: TimeSpan.FromSeconds(1), duration: TimeSpan.FromSeconds(1)));
       trans1.AddLine(new TranscriptLine(trans2.Id, text: "una lunga transcrizione", startsAt: TimeSpan.FromSeconds(2), duration: TimeSpan.FromSeconds(2)));
