...
namespace Videomatic.Client
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.18.2.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class VideomaticClient
    {
        private string _baseUrl = "";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public VideomaticClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl;
        ...
        public virtual System.Threading.Tasks.Task<VideoDTOQueryResponse> GetVideosDTOQueryAsync(int? take, string titlePrefix, string descriptionPrefix, string providerIdPrefix, string providerVideoIdPrefix, string videoUrlPrefix, int? skip, System.Collections.Generic.IEnumerable<string> includes, System.Collections.Generic.IEnumerable<string> orderBy)
        {
            return GetVideosDTOQueryAsync(take, titlePrefix, descriptionPrefix, providerIdPrefix, providerVideoIdPrefix, videoUrlPrefix, skip, includes, orderBy, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<VideoDTOQueryResponse> GetVideosDTOQueryAsync(int? take, string titlePrefix, string descriptionPrefix, string providerIdPrefix, string providerVideoIdPrefix, string videoUrlPrefix, int? skip, System.Collections.Generic.IEnumerable<string> includes, System.Collections.Generic.IEnumerable<string> orderBy, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/videos/GetVideosDTOQuery?");
            if (take != null)
            {
            ...
            if (titlePrefix != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("TitlePrefix") + "=").Append(System.Uri.EscapeDataString(ConvertToString(titlePrefix, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (descriptionPrefix != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("DescriptionPrefix") + "=").Append(System.Uri.EscapeDataString(ConvertToString(descriptionPrefix, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (providerIdPrefix != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("ProviderIdPrefix") + "=").Append(System.Uri.EscapeDataString(ConvertToString(providerIdPrefix, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (providerVideoIdPrefix != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("ProviderVideoIdPrefix") + "=").Append(System.Uri.EscapeDataString(ConvertToString(providerVideoIdPrefix, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (videoUrlPrefix != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("VideoUrlPrefix") + "=").Append(System.Uri.EscapeDataString(ConvertToString(videoUrlPrefix, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (skip != null)
            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<VideoDTOQueryResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task GetTranscriptDTOQueryAsync(int transcriptId)
        {
            return GetTranscriptDTOQueryAsync(transcriptId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task GetTranscriptDTOQueryAsync(int transcriptId, System.Threading.CancellationToken cancellationToken)
        {
            if (transcriptId == null)
                throw new System.ArgumentNullException("transcriptId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/videos/GetTranscriptDTOQuery?");
            urlBuilder_.Append(System.Uri.EscapeDataString("TranscriptId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(transcriptId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task ImportVideoCommandAsync(ImportVideoCommand body)
        {
            return ImportVideoCommandAsync(body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task ImportVideoCommandAsync(ImportVideoCommand body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/videos/ImportVideoCommand");
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task UpdateVideoCommandAsync(UpdateVideoCommand body)
        {
            return UpdateVideoCommandAsync(body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task UpdateVideoCommandAsync(UpdateVideoCommand body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/videos/UpdateVideoCommand");
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task DeleteVideoCommandAsync(string videoUrl)
        {
            return DeleteVideoCommandAsync(videoUrl, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task DeleteVideoCommandAsync(string videoUrl, System.Threading.CancellationToken cancellationToken)
        {
            if (videoUrl == null)
                throw new System.ArgumentNullException("videoUrl");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/videos/DeleteVideoCommand?");
    ...
    public partial class Transcript
    {
        ...
        public System.Collections.Generic.ICollection<TranscriptLine> Lines { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.2.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class TranscriptLine
    {
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int Id { get; set; }
    ...
    public partial class VideoDTO
    {
        ...
        public System.Collections.Generic.ICollection<Transcript> Transcripts { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.2.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class VideoDTOQueryResponse
    {
        [Newtonsoft.Json.JsonProperty("items", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<VideoDTO> Items { get; set; }
