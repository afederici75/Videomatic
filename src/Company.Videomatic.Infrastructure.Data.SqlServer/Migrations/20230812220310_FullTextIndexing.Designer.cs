...
namespace Company.Videomatic.Infrastructure.Data.SqlServer.Migrations
{
    ...
    [Migration("20230812220310_FullTextIndexing")]
            ...
            modelBuilder.Entity("Company.Videomatic.Domain.Aggregates.Playlist.Playlist", b =>
                {
                    ...
                    b.OwnsOne("Company.Videomatic.Domain.Thumbnail", "Picture", b1 =>
                        {
                            b1.Property<int>("PlaylistId")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("Company.Videomatic.Domain.Thumbnail", "Thumbnail", b1 =>
                        {
                            b1.Property<int>("PlaylistId")
                                .HasColumnType("int");
