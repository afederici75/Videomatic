...
public class DataSeeder : IDataSeeder
{
    ...
    async Task<long> CreateEasternPhilosophyPlaylist()
    {
        ...
        var resp = await Sender.Send(new LinkVideosToPlaylistsCommand(new[] { playlist.Id }, new[] { videoId1, videoId2 }));
    ...
    {
        // Video
        var video = await Sender.Send(new CreateVideoCommand(
            Location: "https://www.youtube.com/watch?v=n1kmKpjk_8E", 
            Title: "Aldous Huxley - The Dancing Shiva", 
            Description: "Aldous Huxley beautifully describes the 'The Dancing Shiva' symbol (Nataraja, Nataraj, nət̪əˈraːdʒ) of the Hindu spiritual tradition.  Aldous Huxley was the author of many excellent books and essays including; Brave New World, Island, The Perennial Philosophy and The Doors of Perception. \n\n🎬 A RevolutionLoveEvolve production\nAudio clip is taken from an interview which took place in London, England in 1961 entitled 'Aldous Huxley - Speaking Personally'.\n\nhttps://en.wikipedia.org/wiki/Aldous_Huxley\nhttps://en.wikipedia.org/wiki/Nataraja\nhttps://en.wikipedia.org/wiki/Shiva\n\nSupport the channel:\n🎵 Download my music: https://jamesdeardenbush.bandcamp.com\n👕 Buy a T-Shirt etc: https://www.redbubble.com/people/revoloveevolve/shop \n\nWeb:\n🌐 Website: https://www.jamesdeardenbush.com\n🎵 Music: https://jamesdeardenbush.bandcamp.com\n👕 Merch: https://www.redbubble.com/people/jdeardenbush\n📹 LBRY: https://lbry.tv/$/invite/@jamesdeardenbush:a\n📺 YouTube https://www.youtube.com/jamesdeardenbush\n🎧 Spotify: https://open.spotify.com/artist/0Nv6I1nNV1Fb7hW5rKGHR1\n🍏 Apple Music: https://music.apple.com/gb/artist/james-dearden-bush/1537309293\n📷 Instagram: https://www.instagram.com/jdeardenbush\n🤮 Facebook: https://www.facebook.com/jamesdeardenbush\n🐦 Twitter: https://twitter.com/jdeardenbush\n\nNo copyright is claimed and to the extent that material may appear to be infringed, I assert that such alleged infringement is permissible under fair use principles in U.S. copyright laws. This video is fair use under U.S. copyright law because it is (1) noncommercial (2) transformative in nature, (3) does not compete with the original work or have any negative effect on its market and (4) uses no more of the original work than necessary for the video's purpose. If you believe material has been used in an unauthorized manner, please contact the poster."));
    ...
    async Task<long> CreateIfRealityIsNonDualVideo()
    {
        ...
        var video = await Sender.Send(new CreateVideoCommand(
            ...
            Title: "If Reality is NON-DUAL, Why are there so many GODS in Hinduism?",
            Description: "Hindu scriptures offer different teachings to meet the individual needs of different people - according to the crucial principle of adhikari-bheda (individualism). Q&A with Swamiji #8. \n\nThe teachings of the rishis, the sages of ancient India, are found in the Vedas. The Vedas are a compilation of their teachings, teaching meant for different groups of people. Thus the Vedas include the karma kanda, the section that teaches prayer and rituals for those who want contentment in this life and heaven (swarga) in the next live, and it also includes the jnana kanda, the section on pure spiritual teachings, for those who recognize the limitations of worldly life (samsara) and seek moksha, liberation or enlightenment, instead.\n\nSwami Tadatmananda is a traditionally-trained teacher of Advaita Vedanta, meditation, and Sanskrit. For more information, please see: https://www.arshabodha.org/"));
