...
{ 
    ...
    internal class Handler(IMyRepository<Playlist> repository, IMapper mapper) : UpdateEntityHandler<UpdatePlaylistCommand, Playlist, PlaylistId>(repository, mapper)
    {
    }
